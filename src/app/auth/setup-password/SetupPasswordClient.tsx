...
function SetupPasswordContent({ orgLogo, orgName = 'Free Mind Foundation' }: { orgLogo?: string; orgName?: string }) {
...
export default function SetupPasswordClient({ orgLogo, orgName = 'Free Mind Foundation' }: { orgLogo?: string; orgName?: string }) {
  return (
    <Suspense fallback={<Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100vh' }}><CircularProgress /></Box>}>
      <SetupPasswordContent orgLogo={orgLogo} orgName={orgName} />
    </Suspense>
  )
}
