...
function LoginContent({ orgLogo, orgName = 'Free Mind Foundation' }: { orgLogo?: string; orgName?: string }) {
...
export default function LoginClient({ orgLogo, orgName = 'Free Mind Foundation' }: { orgLogo?: string; orgName?: string }) {
  return (
    <Suspense fallback={<Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100vh' }}><CircularProgress /></Box>}>
      <LoginContent orgLogo={orgLogo} orgName={orgName} />
    </Suspense>
  )
}
